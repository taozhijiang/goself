...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  result_t ping(ping_t req)")
  fmt.Fprintln(os.Stderr, "  add_response_t add(i32 num1, i32 num2)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := calcsrv.NewCalcServiceClient(thrift.NewTStandardClient(iprot, oprot))
